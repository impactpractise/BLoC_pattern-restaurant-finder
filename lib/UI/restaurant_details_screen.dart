...
class RestaurantDetailsScreen extends StatelessWidget {
  ...
  // Use favoriteStream to determine if restaurant is favorite and render appropriate widget
    ...
    return StreamBuilder<List<Restaurant>>(
      ...
      builder: (context, snapshot) {
        ...
        return FlatButton.icon(
          // 2. toggleRestaurant in FavoriteBloc is written so UI does not need to know state of restaurant. Add / remove accordingly.
